...
//char can_timer = 0;
int second =0;
extern char  minute =0;
extern char hour = 0;

//char live_data_interval=0;

int time_of_day = 0;
int input_date[8];
extern char nTdate[8] ;
int time_50ms = 0;
extern char nTtime[8];
...
void get_time_date(unsigned char* time,unsigned char* date){
    sprintf(time,"%.2d%.2d%.2d",hour,minute,second);
    strncpy(date,"120225",7);
}
/* USER CODE END 1 */
